...
This project is indexed by GitNexus as **loom** (1784 symbols, 3951 relationships, 157 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
